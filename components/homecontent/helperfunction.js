...
export const HomeCardsData = [
  {
    ...
    flag:FlagIcon,
    vesselCount:"8",
    companyName:"Blue Star Ferries",
    rate:4.5,
    ferryType:"8 normal",
    customers:"1,342",
    popularVessel:"Blue Star Delos, Blue Star Naxos",
  ...
  },
  {
    ...
    companyName:"Seajets",
    rate:2.5,
    ferryType:"10 normal and 7 high-speed" ,
    customers:"2,467",
    popularVessel:"WorldChampion jet, Seajet 2",
  ...
  },
  {
    ...
    flag:FlagIcon,  
    vesselCount:"6",
    companyName:"Anek-Superfast",
    rate:2.5,
    ferryType:"Normal Ferries" ,
    customers:"667",
    popularVessel:"Superfast XII, Superfast XI",
    ...
    moreText:"More about Anek - Superfast" 
  },
